...
Livingston maps to the HVE Bicep code role and owns AVM-first Bicep outputs.
...
Day-1 context: Bicep generation depends on planner outputs and governance constraints.
