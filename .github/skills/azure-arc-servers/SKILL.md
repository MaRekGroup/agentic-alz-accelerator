...
## Brownfield Playbook — S6: Hybrid Estate Governance
...
AVM module reference for Bicep: `br/public:avm/res/hybrid-compute/machine:0.x.x` (check AVM catalog for current version). Extension resources nest under the `Microsoft.HybridCompute/machines/extensions` resource type.
