...
PATTERNS=(
  ...
  # Infrastructure destruction (ALZ-specific)
  ...
  "infra_destruction:::critical:::az group delete:::Use 'az group delete --no-wait' with confirmation"
  "infra_destruction:::critical:::az deployment sub delete:::Review deployment resources before deleting"
  "infra_destruction:::critical:::az account management-group delete:::Never delete management groups without review"
