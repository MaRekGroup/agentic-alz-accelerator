...
'mrg-lz-corp-erp' in southcentralus.
...
| Profile | corp |
| Subscription | mrg-lz-corp-erp (`<SUB-5-ID>`) |
...
![corp-erp Architecture — As-Built](TDD_corp-erp_20260417_architecture.png)
