...
> **Profile**: corp · **Environment**: prod · **Generated**: 2026-04-17 22:47 UTC

| Field | Value |
|-------|-------|
| Subscription | alz-lz-corp-erp |
| Subscription ID | `<SUB-5-ID>` |
...
'corp-erp' landing zone deployed to subscription
'alz-lz-corp-erp' in southcentralus.
...
| Attribute | Value |
|-----------|-------|
| Landing Zone | corp-erp |
| Profile | corp |
| Subscription | alz-lz-corp-erp (`<SUB-5-ID>`) |
...
![corp-erp Architecture — As-Built](TDD_corp-erp_20260417_architecture.svg)

*Figure 1: corp-erp Architecture — As-Built*
...
![Full Azure Landing Zone Estate](TDD_corp-erp_20260417_estate.svg)
