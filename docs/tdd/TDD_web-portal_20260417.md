...
> **Profile**: online · **Environment**: prod · **Generated**: 2026-04-17 22:47 UTC

| Field | Value |
|-------|-------|
| Subscription | mrg-lz-online-web |
| Subscription ID | `<SUB-7-ID>` |
...
'web-portal' landing zone deployed to subscription
'mrg-lz-online-web' in southcentralus.
...
| Attribute | Value |
|-----------|-------|
| Landing Zone | web-portal |
| Profile | online |
| Subscription | mrg-lz-online-web (`<SUB-7-ID>`) |
...
![web-portal Architecture — As-Built](TDD_web-portal_20260417_architecture.png)

*Figure 1: web-portal Architecture — As-Built*
...
![Full Azure Landing Zone Estate](TDD_web-portal_20260417_estate.svg)
