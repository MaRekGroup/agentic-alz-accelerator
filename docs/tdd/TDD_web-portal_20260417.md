...
| Field | Value |
|-------|-------|
| Subscription | alz-lz-online-web |
...
'alz-lz-online-web' in southcentralus.
...
| Profile | online |
| Subscription | alz-lz-online-web (`<SUB-7-ID>`) |
...
![web-portal Architecture — As-Built](TDD_web-portal_20260417_architecture.svg)
