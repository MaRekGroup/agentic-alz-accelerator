...
A WARA/CAF assessment was performed on `mrg` scoring **42.2/100** overall.
The assessment identified **44** findings across 280 checks.
...
**Problem**: Enable Azure Backup for production virtual machines to improve recovery readiness.
